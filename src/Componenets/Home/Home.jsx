...
const Home = () => {
    ...
    return (
            ...
            <section className="hero h-[700px] relative bg-center rounded-lg" style={{ backgroundImage: 'url("https://i.ibb.co/YkZ0MnQ/olav-tvedt-o-Va-YMg-BMbs-unsplash.jpg")' }}>
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg">
                    <div className="grid hero-content text-center text-white">
                        <h1 className="text-6xl font-extrabold mb-4">Explore the World of Cars</h1>
                        <p className="text-lg mb-6">Your Ultimate Source for Car Enthusiasts</p>
                        <a href="/" className="btn bg-purple-950 hover:bg-purple-700 btn-primary shadow-2xl">Read Our Blog</a>
                    </div>
                </div>
            </section>
        ...
        <div className="container mx-auto">
          <h2 className="text-5xl font-extrabold text-purple-800 text-center mb-8">Our Brands</h2>
          <h2 className="text-lg font-bold text-center mb-8">Choose your prefered brand</h2>
