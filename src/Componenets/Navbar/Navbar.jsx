    ...
    return (
        <div className="navbar bg-purple-950">
            ...
            <div className="navbar-end  gap-2 ">
                    ...
                    {user ? (
                        <>
                            ...
                            <a
                                ...
                                onClick={handleLogOut} className="btn btn-sm btn-warning w-30 lg:w-44 ml-4">Sign Out</a>
                        </>
                    ) : (
                ...
                <button  onClick={changeTheme} className={`btn ${theme === 'dark' ? 'dark:bg-gray-900 text-white' : 'bg-white text-gray-900'} w-16 rounded-full` }>
                        {theme === 'dark' ? (
                            <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/moon-symbol.png" alt="moon-symbol" />
                        ) : (
                            <img width="50" height="50" src="https://img.icons8.com/ios/50/moon-symbol.png" alt="moon-symbol" />
                        )}
                        {theme === 'dark' ? '' : ''}
                    </button>
